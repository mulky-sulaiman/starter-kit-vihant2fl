                    ...
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <Link v-bind:href="route('user.index')" class="block py-2 pl-3 pr-4" v-bind:class="{
                                'text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white': $page.props.ziggy.route_name === 'user.index',
                                'text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700': $page.props.ziggy.route_name !== 'user.index'
                            }">
                            Users</Link>
                        </li>
                    </ul>
