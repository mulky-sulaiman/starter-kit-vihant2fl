...
<template>
    <div>
        <a href="#" data-tooltip-target="tooltip-back-to-top" v-bind:data-tooltip-placement="placement"
            v-on:click.prevent="backToTop"
            ...
            <Icon icon="tabler:arrow-up" class="size-5 animate-bounce" />
        </a>
        <div id="tooltip-back-to-top" role="tooltip"
            class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
            <span>{{ $t('global.back_to_top') }}</span>
