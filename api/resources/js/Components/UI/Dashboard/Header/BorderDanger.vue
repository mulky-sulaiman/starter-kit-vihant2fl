...
<template>
    <nav class="fixed z-30 w-full bg-white border-b-4 border-danger-700 dark:bg-gray-800 dark:border-danger-600">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <template v-if="$page.props.auth.user">
                        <!-- Notification -->
                        <UIMenuNotification mode="danger" />
                        <UISeparator />
                        <!-- App Switcher -->
                        <UISwitcherApp mode="danger" />
                        <UISeparator />
                        <!-- User Menu -->
                        <UIMenuUser mode="danger" />
                    </template>
                    <template v-else>
