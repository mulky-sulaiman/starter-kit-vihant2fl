...
<template>
    <nav class="fixed z-30 w-full bg-white border-b-4 border-primary-700 dark:bg-gray-800 dark:border-primary-600">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <template v-if="$page.props.auth.user">
                        <!-- Notification -->
                        <UIMenuNotification mode="primary" />
                        <UISeparator />
                        <!-- App Switcher -->
                        <UISwitcherApp mode="primary" />
                        <UISeparator />
                        <!-- User Menu -->
                        <UIMenuUser mode="primary" />
                    </template>
                    <template v-else>
