        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <span
                        class="self-center text-xl font-semibold tracking-widest uppercase xxs:hidden xs:block sm:text-2xl whitespace-nowrap dark:text-white">{{
                ...
                <div class="flex items-center">
                    ...
                    <button ref="toggleSidebarMobileSearch" id="toggleSidebarMobileSearch" type="button"
                        class="hidden p-2 text-gray-500 rounded-lg lg:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
