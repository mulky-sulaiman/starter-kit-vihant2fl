...
<template>
    <UIMenuDropdown id="notification-menu" class="p-2 rounded-lg"
        ...
        v-bind:class="{
            '!text-gray-500 rounded-lg hover:!text-gray-900 hover:!bg-gray-100 dark:!text-gray-400 dark:hover:!text-white dark:hover:!bg-gray-700': mode ==
                'light',
        ...
        <div>
            <UIMenuDropdownItem as="a" v-bind:useLinkClass="false" href="#"
