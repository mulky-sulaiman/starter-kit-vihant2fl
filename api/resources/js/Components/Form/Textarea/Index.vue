...
<template>
    <textarea ref="input" v-model="model" class="textarea" v-bind:class="{
        'textarea-is-invalid': hasError && !isDirty,
        'textarea-is-dirty': isDirty,
        'textarea-is-valid': isSuccess && !isDirty
    }" v-bind:row="row" v-bind="$attrs"></textarea>
</template>
