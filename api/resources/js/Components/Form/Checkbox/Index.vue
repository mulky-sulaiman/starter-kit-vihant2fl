...
<template>
    <input ref="input" type="checkbox" v-model="model" class="checkbox" v-bind:class="{
        'checkbox-is-invalid': hasError && !isDirty,
        'checkbox-is-dirty': isDirty,
        'checkbox-is-valid': isSuccess && !isDirty
    }" v-bind="$attrs" />
</template>
