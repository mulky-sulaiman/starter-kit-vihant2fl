...
import FormCheckbox from '@/Components/Form/Checkbox/Index.vue'
...
<template>
    <div class="flex flex-col space-y-2">
        ...
        <FormLabel v-bind:for="name" v-bind:required="isRequired" v-bind:dirty="isDirty" v-bind:error="hasError"
            v-bind:success="isSuccess" class="flex items-center justify-start gap-3 cursor-pointer !mb-0">
            <template #label>
                <!-- Checkbox Block -->
                <FormCheckbox v-model="model" v-bind:identifier="identifier" v-bind:id="id" v-bind:name="name"
