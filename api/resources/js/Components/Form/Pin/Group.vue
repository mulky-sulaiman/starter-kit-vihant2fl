...
import FormPin from '@/Components/Form/Pin/Index.vue'
    ...
    <div class="flex flex-col space-y-2">
        <template v-if="label || slots.label">
            ...
            <FormLabel v-bind:for="name" v-bind:required="isRequired" v-bind:dirty="isDirty" v-bind:error="hasError"
                v-bind:success="isSuccess" v-bind:class="[alignmentClass]">
        ...
        <!-- Pin Block -->
        <FormPin v-model="model" v-bind:identifier="identifier" v-bind:id="id" v-bind:name="name"
            v-bind:alignment="alignment" v-bind:formIsDirty="formIsDirty" v-bind:hasError="hasError"
            v-bind:isSuccess="isSuccess" v-on:is-dirty="setDirty" v-bind="$attrs" />
        <template v-if="useMessage">
            <!-- Message Block -->
            <!-- Error -->
            <template v-if="hasError">
                <FormMessage type="error" v-bind:class="alignmentClass">
                    <template #message>
                        {{ error }}
                    </template>
                </FormMessage>
            ...
            <template v-if="isDirty && (!hasError && !isSuccess)">
                <FormMessage type="dirty" v-bind:class="alignmentClass">
                    <template #message>
            ...
            <template v-if="isSuccess">
                <FormMessage type="success" v-bind:class="alignmentClass">
                    <template #message>
                        {{ success }}
                    </template>
                </FormMessage>
            ...
            <template v-if="hint || slots.hint">
                <FormMessage type="hint" v-bind:class="alignmentClass">
                    <template #message>
                        <template v-if="hint">
                            {{ hint }}
                        </template>
