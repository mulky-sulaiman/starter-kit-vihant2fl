...
defineOptions({
    layout: [LayoutsDefault, LayoutsDashboard]
})
</script>
<template>

    <UIPageHeader title="Page Title" mode="flex" v-bind:boxed="true">
        <template #left>
    ...
    <UIPageLayoutGrid v-bind:cols="4">
        ...
        <UIPageHeader title="Page Title" mode="grid" v-bind:boxed="true">
            <template #left>
                <div class="flex items-center mb-4 sm:mb-0">
                    <form class="sm:pr-3" action="#" method="GET">
                        <label for="products-search" class="sr-only">Search</label>
