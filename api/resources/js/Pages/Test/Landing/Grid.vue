...
import UIPageLayoutGrid from '@/Components/UI/Page/Layout/Grid.vue'
...
<template>
    ...
    <UIPageLayoutWrapper>
        <UIPageLayoutGrid v-bind:cols="4">
            <UIPageHeader mode="grid" v-bind:boxed="true"></UIPageHeader>

            <UIPageHeader title="Flex Grid" mode="grid" v-bind:boxed="true" root="home"
                v-bind:breadcrumbs="breadcrumbs">
                <template #top_right>
                    <UIButton size="sm" rounded="lg" as="button" type="dark">Action</UIButton>
                </template>
            </UIPageHeader>

            <UIPageHeader title="Page Title" mode="grid" v-bind:boxed="false">
                <template #left>
