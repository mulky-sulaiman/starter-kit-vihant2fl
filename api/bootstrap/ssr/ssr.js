  ...
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const page2 = resolvePageComponent(
        `./Pages/${name}.vue`,
        /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-BcgI-vhn.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-BYfv3UKu.js"), "./Pages/Auth/Recover.vue": () => import("./assets/Recover-DhSrbGz0.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-PByj5zXD.js"), "./Pages/Auth/Reset.vue": () => import("./assets/Reset-BzSJXwJO.js"), "./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge-DH2z36N0.js"), "./Pages/Auth/TwoFactorEnable.vue": () => import("./assets/TwoFactorEnable-nlsLYvN_.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-berm9lbd.js"), "./Pages/Dashboard/Account/Form/ChangePasswordForm.vue": () => import("./assets/ChangePasswordForm-25to5QzR.js"), "./Pages/Dashboard/Account/Form/TwoFactorForm.vue": () => import("./assets/TwoFactorForm-Cn6NeO-C.js"), "./Pages/Dashboard/Account/Form/TwoFactorFormOld.vue": () => import("./assets/TwoFactorFormOld-nfvSjBE8.js"), "./Pages/Dashboard/Account/Index.vue": () => import("./assets/Index-B48NTVnE.js"), "./Pages/Dashboard/Account/Security.vue": () => import("./assets/Security-CxI7XKIm.js"), "./Pages/Dashboard/Index.vue": () => import("./assets/Index-CmRrDisZ.js"), "./Pages/Home.vue": () => import("./assets/Home-BArvzSS9.js"), "./Pages/Test/Form.vue": () => import("./assets/Form-BifOr1YQ.js"), "./Pages/User/Index.vue": () => import("./assets/Index-B9SqaU3G.js") })
      );
      page2.then((module) => {
    ...
    setup({ App, props, plugin }) {
      return createSSRApp({
        ...
        resolve: (name) => {
          const page2 = resolvePageComponent(
            `./Modals/${name}.vue`,
            /* @__PURE__ */ Object.assign({ "./Modals/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-DRIUFIWn.js"), "./Modals/Auth/Login.vue": () => import("./assets/Login-BgXnPViv.js"), "./Modals/Auth/Register.vue": () => import("./assets/Register-BJI83eMe.js"), "./Modals/Auth/TwoFactorEnable.vue": () => import("./assets/TwoFactorEnable-bvJKMBP0.js") })
          );
          page2.then((module) => {
            if (module.default.layout === void 0) {
              module.default.layout = _sfc_main$2;
