...
import { _ as _sfc_main$3 } from "./Label-D1c1ZHt3.js";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (_ctx.$page.props.features["email-verification"] && unref(page).props.auth.user.email_verified_at === null) {
                    _push3(`<div${_scopeId2}><p class="mt-2 text-sm dark:text-white"${_scopeId2}> Your email address is unverified. `);
                  ...
                  _push3(`</div></div></div><div class="space-y-4 md:space-y-6"${_scopeId2}><div class="col-span-6"${_scopeId2}>`);
                        ...
                        createVNode("div", { class: "space-y-4 md:space-y-6" }, [
                          createVNode("div", { class: "grid grid-cols-6 gap-6" }, [
                            ...
                            createVNode("div", { class: "col-span-6 sm:col-span-3" }, [
                              ...
                              _ctx.$page.props.features["email-verification"] && unref(page).props.auth.user.email_verified_at === null ? (openBlock(), createBlock("div", { key: 0 }, [
