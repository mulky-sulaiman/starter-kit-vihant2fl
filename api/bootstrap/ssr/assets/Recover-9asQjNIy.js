import { defineComponent, resolveComponent, unref, withCtx, withDirectives, createVNode, vShow, toDisplayString, createTextVNode, withModifiers, useSSRContext } from "vue";
            ...
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_sfc_main$2, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="items-center p-4 space-y-4 md:p-6 md:space-y-6"${_scopeId2}><p${_scopeId2}>Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</p><div${_scopeId2}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Modals/Auth/Recover.vue");
