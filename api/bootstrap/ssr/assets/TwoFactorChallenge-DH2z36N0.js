...
import { _ as _sfc_main$6 } from "./Group-g9-2m5yW.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$3, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="p-6 space-y-4 md:space-y-6 sm:p-8"${_scopeId2}><h1 class="text-xl font-bold leading-tight tracking-tight text-center text-gray-900 md:text-2xl dark:text-white"${_scopeId2}>${ssrInterpolate(_ctx.$t("global.two_factor_challenge"))}</h1>`);
                  if (__props.status) {
                    _push3(ssrRenderComponent(_sfc_main$4, { status: __props.status }, null, _parent3, _scopeId2));
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<form class="space-y-4 md:space-y-6"${_scopeId2}>`);
                  if (showCode.value) {
                  ...
                  _push3(`<div${_scopeId2}></div><a href="#" class="text-sm font-light text-gray-500 dark:text-gray-400"${_scopeId2}>${ssrInterpolate(showCode.value ? "Use Recovery Code Instead" : "Use Authenticator Code Instead")}</a>`);
                  ...
                  return [
                    createVNode("div", { class: "p-6 space-y-4 md:space-y-6 sm:p-8" }, [
                      createVNode("h1", { class: "text-xl font-bold leading-tight tracking-tight text-center text-gray-900 md:text-2xl dark:text-white" }, toDisplayString(_ctx.$t("global.two_factor_challenge")), 1),
